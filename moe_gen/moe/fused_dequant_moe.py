...
def fused_dequant_weighted_moe_kernel(
	lhs_ptr, gate_ptrs_ptr, up_ptrs_ptr, down_ptrs_ptr,
	...
	stride_gate_n, stride_gate_k,
	stride_up_n, stride_up_k,
	stride_down_n, stride_down_k,
	stride_output_m, stride_output_n,
	stride_grouped_idx, stride_group_sizes, stride_group_start_indices,
	stride_weight_ptrs, stride_scale_ptrs,

	GATE_GEMM_BLOCK_SIZE_M: tl.constexpr, GATE_GEMM_BLOCK_SIZE_N: tl.constexpr, GATE_GEMM_BLOCK_SIZE_K: tl.constexpr,
	UP_GEMM_BLOCK_SIZE_M: tl.constexpr, UP_GEMM_BLOCK_SIZE_N: tl.constexpr, UP_GEMM_BLOCK_SIZE_K: tl.constexpr,
	DOWN_GEMM_BLOCK_SIZE_M: tl.constexpr, DOWN_GEMM_BLOCK_SIZE_N: tl.constexpr, DOWN_GEMM_BLOCK_SIZE_K: tl.constexpr,
	SCALE_BLOCK_SIZE_N: tl.constexpr, SCALE_BLOCK_SIZE_K: tl.constexpr
):
	pid = tl.program_id(axis=0)
	lhs_dtype = tl.bfloat16
	...
	offsets_n = pid * GATE_GEMM_BLOCK_SIZE_M + tl.arange(0, GATE_GEMM_BLOCK_SIZE_N)
