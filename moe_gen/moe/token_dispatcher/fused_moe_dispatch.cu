...
std::vector<torch::Tensor> fused_moe_token_dispatch_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(global_x.scalar_type(), "count_local_expert_tokens", ([&] {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(global_x.scalar_type(), "fused_moe_token_dispatch", ([&] {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("fused_moe_token_dispatch", &fused_moe_token_dispatch_cuda, "Fused MoE Token Dispatch");
}