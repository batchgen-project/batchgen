...
from moe_gen.moe.moe_weighted_sum import moe_weighted_sum_triton_v2, moe_weighted_sum_triton
class DeepseekV3MoE_Decoding_FP8(nn.Module): 
	...
	def moe_infer_allgather_allreduce_opt(self, x):
		...
		# global_results = weighted_output.sum(dim=1)
		global_results = moe_weighted_sum_triton(global_results, topk_weight, False)
