...
class Qwen3Moe_Parameter_Server:
    ...
    def Init(self):
        ...
        if "30B-A3B" in self.huggingface_ckpt_name:
            byte_size = 65 * 1024 * 1024 * 1024 * 2
        elif "235B-A22B" in self.huggingface_ckpt_name:
            byte_size = 240 * 1024 * 1024 * 1024 * 2
        else:
    ...
    def _parse_state_dict(self):
        ...
        model = Qwen3MoeForCausalLM._from_config(self.hf_model_config)
        model.eval()
