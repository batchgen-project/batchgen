...
RELEASE_URL="https://github.com/EfficientMoE/BatchGen/releases/download/v1.0.9.post5"
pip install \
  ...
  "${RELEASE_URL}/batchgen_kernels-0.3.1.post3-cp311-cp311-linux_x86_64.whl" \
  "${RELEASE_URL}/batchgen-1.0.9.post5-py3-none-any.whl"
```
