...
RELEASE_URL="https://github.com/batchgen-project/batchgen/releases/download/v1.0.10.post3"
pip install \
  ...
  "${RELEASE_URL}/batchgen-1.0.10.post3-py3-none-any.whl"
```
...
```bash
gh release create v1.0.10.post3 --title "BatchGen v1.0.10.post3"
gh release upload v1.0.10.post3 /path/to/wheels/*.whl
```
