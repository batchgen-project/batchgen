...
RELEASE_URL="https://github.com/EfficientMoE/BatchGen/releases/download/v1.0.8"
pip install \
  ...
  "${RELEASE_URL}/batchgen_kernels-0.3.0-cp311-cp311-linux_x86_64.whl" \
  "${RELEASE_URL}/batchgen-1.0.8-py3-none-any.whl"
```
