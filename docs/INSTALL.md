...
RELEASE_URL="https://github.com/EfficientMoE/BatchGen/releases/download/v1.0.2"
pip install \
...
```bash
gh release create v1.0.2 --title "BatchGen v1.0.2"
gh release upload v1.0.2 /path/to/wheels/*.whl
```
