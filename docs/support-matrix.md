...
| Kimi-K2.5 | 1.04T | INT4 / W4A16 | 16× H20 long-context campaign | Benchmark evidence | Recent 255K prefill result: 1.61× faster than tuned SGLang in the recorded workload. |
| Kimi-K3 | 2.8T | MXFP4, 896 experts | 2×8 H200; 4×8 H20 guides | Documented deployment · Benchmark evidence | Recent exact-64K prefill result: 1.42× faster than SGLang 0.5.18 in the recorded workload. |
