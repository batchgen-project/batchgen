...
def fused_mxfp4_gemm_kernel(
    ...
    for k_block in range(0, tl.cdiv(K, BLOCK_K)):
        ...
        val_lo_scaled = ldexp_triton(val_lo, exp_broadcast)  # [BLOCK_N, 16]
        val_hi_scaled = ldexp_triton(val_hi, exp_broadcast)  # [BLOCK_N, 16]
        ...
        # val_lo.T: [16, BLOCK_N]
        acc += tl.dot(lhs_even.to(tl.bfloat16), tl.trans(val_lo_bf16))
        acc += tl.dot(lhs_odd.to(tl.bfloat16), tl.trans(val_hi_bf16))
