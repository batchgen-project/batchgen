...
The classes here are thin presets on top of the generic Host/GPU KV
coordinators. They do not proxy view/manager APIs. They only register the
DeepSeek-V4 KV components and attach the layer/token routing metadata needed
by callers.
"""
...
class DeepSeekV4HostKVCoordinator(HostKVCoordinator):
	"""Host-side component registry for DeepSeek-V4 KV views."""
...
class DeepSeekV4GPUKVCoordinator(GPUKVCoordinator):
	"""GPU-side component registry for DeepSeek-V4 KV managers."""
