...
class WorkerManager:
    ...
    def _load_model_locally(
        ...
        # Get skeleton_state_dict - PyTorch multiprocessing will share it via /dev/shm
        self.skeleton_state_dict = parameter_server.parameter_server.get_skeleton_state_dict()
        logger.info(f"Retrieved skeleton state dict with {len(self.skeleton_state_dict)} keys")
