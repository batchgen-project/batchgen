...
# ──────────────────────────────────────────────────────────────────────────────
# CUDA Source Code (merged Stage 1 + Stage 2, TMA-based, INT4 dequant)
# ──────────────────────────────────────────────────────────────────────────────

CUDA_SOURCE_GROUPED_INT4_MOE = r'''
...
def _load_int4_grouped_module():
    """Load the grouped INT4 WGMMA CUDA module (Stage 1 + Stage 2)."""
    ...
    try:
        ...
        _int4_grouped_module = load_inline(
            name="batchgen_fused_int4_grouped_wgmma_tma_v1",
            cpp_sources=[""],
            cuda_sources=[CUDA_SOURCE_GROUPED_INT4_MOE],
