...
class GptOss_Parameter_Server:
    ...
    def _convert_checkpoint(self):
        ...
        logging.info("  block.{L}.attn.norm.scale -> model.layers.{L}.input_layernorm.weight")
        logging.info("  block.{L}.mlp.norm.scale  -> model.layers.{L}.post_attention_layernorm.weight")
        logging.info("")
        ...
        logging.info("  norm.scale         -> model.norm.weight (NOTE: .scale not .weight)")
