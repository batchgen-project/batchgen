...
class KimiLinearPlanner(BasePlanner):
    ...
    def _adjust_config_for_k3(self):
        ...
        against the GPU's usable HBM, before the skeleton, the KDA state
        pools, the expert ring, activations or the CUDA context. Streaming
        all four module types is what makes an 8-GPU node possible at all.
        """
