...
Run (on a CUDA GPU, from the repo root, with fla importable):
    python tests/gpu/verify_k3_mxfp4_expert.py --meta
    CUDA_VISIBLE_DEVICES=1 python tests/gpu/verify_k3_mxfp4_expert.py --gpu
"""
