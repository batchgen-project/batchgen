...
MEASURED (<gpu-host>, GPU 0, 2026-08-13): max_pre == 0 for every G and
...
Launch (from repo root ON <gpu-host>):
...
pytestmark = pytest.mark.skipif(
    ...
    reason="staged for <gpu-host> GPU 0 (fla KDA kernels are CUDA)")
