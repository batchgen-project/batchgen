#!/usr/bin/env python3
"""STAGED GPU parity ladder for the K3 Marlin-MXFP4 kernels.

NOT run by the CPU workflow. Staged for a dedicated CUDA GPU (keep it off
the GPU the model workstream is using). No benchmarks here — parity only.
